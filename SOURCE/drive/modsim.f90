...
!     Initialize simulation.                                                    
      ...
      !open(unit=44,file='HVS Unit State.csv', ACTION='write', STATUS='replace')
      !! MAG 190911 print time label and header line
	  !write(44, fmt="(a)", advance="no") "sim time, unit, "
	  !write(44, '(9999(i4, a))') (i, ",", i=1,nstate)
...
!       superblock.  subroutine inscan scans superblock inputs.                 
      ...
      !write(44, fmt="(f7.0)", advance="no") 0
	  !write(44, fmt="(a)", advance="no") ", "
