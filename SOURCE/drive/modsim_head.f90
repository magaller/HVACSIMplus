...
!    msumary = MAX(MSEQIS,MSEQIB,MINOIU,MRPTIS,MAXLBL)
 ...
 integer,parameter  :: maxsbk=40,maxblk=50,maxunt=500,maxstv=3000,maxdeq=90
 integer,parameter  :: maxpar=5000,maxsav=9000,maxbnd=300,mdmbnd=maxbnd*8          
 integer,parameter  :: mblkis=20,muntib=200                                        
 integer,parameter  :: mdeqis=50,mdeqiu=10,mseqis=20,mseqib=500                    
 integer,parameter  :: mbndis=300,minoib=2000,minoiu=50,mrptis=1000,maxlbl=8          
 integer,parameter  :: mpariu=30,mdmrep=mrptis*maxsbk                             
 integer,parameter  :: maxtyp=700                                                 
 integer,parameter  :: nlscre=19                                                  
 integer,parameter  :: minois=mblkis*minoib                                       
 integer,parameter  :: msumary=1000                                                 
